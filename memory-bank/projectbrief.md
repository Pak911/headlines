...
## Core Purpose
Create an engaging word puzzle game where players swap individual letters to reconstruct news headlines arranged in a crossword format.
...
- Minimum number of swaps tracking
- Victory detection when all letters are correctly placed
