...
const ru = {
    ...
    createPuzzle: {
        ...
        previewTitle: "✨ Кроссворд успешно создан",
        statsWords: "Слов:",
        statsLanguage: "Язык:",
        createLinkButton: "Создать ссылку на паззл",
        shareLabel: "Поделитесь этой ссылкой:",
        copyButton: "Скопировать ссылку",
        previewHeader: "Превью: Один из возможных вариантов раскладки",
        previewDisclaimer: "Примечание: Это один из примеров раскладки, созданной для вашего устройства. Фактическая раскладка головоломки может отличаться на разных устройствах в зависимости от размера экрана и соотношения сторон.",
